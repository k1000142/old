...
/**
 * This class stands for Medidas StructType
 * @subpackage Structs
 */
class Medidas extends AbstractStructBase
{
    /**
     * The Altura
    ...
    public $namepc;
    /**
     * Constructor method for Medidas
     * @uses Medidas::setAltura()
     * @uses Medidas::setAncho()
     * @uses Medidas::setLargo()
     * @uses Medidas::setVolumen()
     * @uses Medidas::setPesoVolumen()
     * @uses Medidas::setPeso()
     * @uses Medidas::setCajas()
     * @uses Medidas::setRemision()
     * @uses Medidas::setNamepc()
     * @param float $altura
     * @param float $ancho
     * @param float $largo
     * @param float $volumen
     ...
     * @param string $namepc
     */
    public function __construct($altura = null, $ancho = null, $largo = null, $volumen = null, $pesoVolumen = null, $peso = null, $cajas = null, $remision = null, $namepc = null)
    {
        $this
            ->setAltura($altura)
            ->setAncho($ancho)
